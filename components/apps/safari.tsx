...
export default function Safari({ isDarkMode = true }: SafariProps) {
  const [url, setUrl] = useState("https://yourportfolio.dev")
  ...
  const socialLinks = [
    {
      title: "LinkedIn",
      url: "https://www.linkedin.com/in/shobhitkapoor1",
      icon: "/linkedin.png",
    },
    {
      title: "GitHub",
    ...
    {
      title: "Email",
      url: "mailto:shobhit1kapoor@gmail.com",
      icon: "/mail.png",
    },
  ]
            ...
            <div className="p-8">
              ...
              <div className="mt-8 max-w-2xl mx-auto">
                <div className={`p-6 rounded-lg ${cardBg}`}>
                  <h3 className="text-xl font-semibold mb-4">Shobhit Kapoor - Portfolio</h3>
                  <p className="mb-4">
                    Welcome to my portfolio! I'm a Data Analyst and Machine Learning Engineer passionate about extracting
                    insights from data and building intelligent systems that solve real-world problems.
                  </p>
                  <p className="mb-4">
                    Currently pursuing Computer Science at The University of Texas at Dallas, with expertise in Python,
                    Machine Learning, Data Analytics, and Cloud Technologies. I specialize in building end-to-end ML
                    pipelines and creating data-driven solutions.
                  </p>
